...
| [API Indemnités Pôle emploi](/les-api/api-indemnisation-pole-emploi)   | Montant des indemnités versées par pôle emploi   |✅ Disponible |[[API  particulier]](https://particulier.api.gouv.fr/catalogue) |Pôle Emploi                        |
