...
| **Statut complémentaire santé solidaire (CSS)**, avec ou sans participation - Direction de la sécurité sociale | ⌛️ Avec FranceConnect&nbsp;: _prévu T2 2023_    | ⌛️ Sans FranceConnect&nbsp;: _prévu T2 2023 dans le [bouquet API Particulier](https://particulier.api.gouv.fr/catalogue)_    |
| **Statut revenu de solidarité active (RSA)** - Direction de la sécurité sociale | ⌛️ Avec FranceConnect&nbsp;: _prévu T4 2023_    | ⌛️ Sans FranceConnect&nbsp;: _prévu T4 2023 dans le [bouquet API Particulier](https://particulier.api.gouv.fr/catalogue)_    |
