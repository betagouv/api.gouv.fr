...
| **Montants des paiements des allocations ou des aides** - Pôle emploi |✅ Avec FranceConnect : [API Indemnités Pôle emploi - Pôle Emploi](/les-api/api-indemnisation-pole-emploi)  | ⌛️ Sans FranceConnect : prévu T2 2023 dans le [bouquet API Particulier](https://particulier.api.gouv.fr/catalogue) |
| **Statut complémentaire santé solidaire (CSS)**, avec ou sans participation - Direction de la sécurité sociale | ⌛️ Avec FranceConnect : prévu T2 2023    | ⌛️ Sans FranceConnect : prévu T2 2023 dans le [bouquet API Particulier](https://particulier.api.gouv.fr/catalogue)    |
| **Statut revenu de solidarité active (RSA)** - Direction de la sécurité sociale | ⌛️ Avec FranceConnect : prévu T4 2023    | ⌛️ Sans FranceConnect : prévu T4 2023 dans le [bouquet API Particulier](https://particulier.api.gouv.fr/catalogue)    |
