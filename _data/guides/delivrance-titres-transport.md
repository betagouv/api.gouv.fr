...
| --- | --- |
| Montpellier Méditerranée Métropole | Transports publics |
...
| Grand Lyon | Transports publics |
| Île de France Mobilités | Transports publics |
| Nantes Métropole | Transports publics |
| La Réunion - SEMTO | Transports publics |
| Toulouse Métropole | Transports publics |
| CA Val de Garonne | transports scolaires |
| SM Artois Mobilités | transports scolaires |
| Clermont Auvergne Métropole | transports scolaires |
