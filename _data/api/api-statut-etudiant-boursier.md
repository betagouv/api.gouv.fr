...
access_page:
  - who:
    ...
    is_eligible: -1
    description: |
      L’usage du bouquet API Particulier, incluant l'API statut étudiant boursier, est **uniquement reservé aux acteurs publics** : les administrations, les collectivités, leurs opérateurs, les acteurs de santé, etc.
...
doc_tech_external: https://particulier.api.gouv.fr/developpeurs/openapi#tag/Statut-etudiant-boursier/paths/~1api~1v2~1etudiants-boursiers/get # 📍 URL vers la documentation technique de l'API
