...
export const EligibleEditeurNotOk =
  "**Vous êtes éligible mais votre éditeur/profil acheteur n’a pas intégré l’API Entreprise<span role=\"img\" aria-label=\"émoji loupe\">🔎</span>** \
  \n \
...
export const EditeurAskAdministration =
  "**L’administration pour laquelle vous proposez une prestation est éligible à l’API Entreprise **<span role='img' aria-label='émoji ok'>👍</span> \
  \n \
