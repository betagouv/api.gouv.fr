...
<div className="hero-section text-wrapper text-style">
  <div>
    ...
    <h2>Dans le cadre du mois de l'innovation publique, participez à notre appel à idées</h2>
    <ButtonLink
...
<div className="question-section section">
  <div className="text-wrapper text-style">
    <p>
      Administration, collectivité, entreprise privée, association, citoyen, cet appel à idées vous concerne ! La mission de l'équipe API est de faciliter la circulation des données afin de :
    </p>
    <ul>
      <li>
        permettre la création de nouveaux usages et services
      </li>
      <li>
...
<div className="section">
  <div className="text-wrapper text-style">
    ...
    <div>
      Vos contributions sont récoltées grâce à un formulaire FramaForm Open Source. Nous souhaitons grâce à elles :
      <ul>
        <li>Mieux comprendre les données qui vous intéressent et l'usage que vous souhaitez en avoir</li>
        <li>Produire une synthèse courant décembre présentant les grandes tendances qui ressortent de cet appel à idée</li>
        <li>Contacter les différents fournisseurs de donnés afin d'envisager la mise à disposition de ces dernières</li>
      </ul>
...
<div className="qui-sommes-nous section">
  <div className="text-wrapper text-style text-center">
    ...
    <p>
      ...
      afin de récolter vos idées de projets et les données publiques auxquelles
      vous rêveriez d'accéder afin de les réaliser.
    </p>
  </div>
</div>
<div className="section">
