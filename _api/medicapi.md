...
Cette API expose les [médicaments](http://base-donnees-publique.medicaments.gouv.fr/telechargement.php) référencés [<abbr title="Agence nationale de Sécurité du Médicament">ANSM</abbr>](http://ansm.sante.fr/) mises à jour le 24/06/2016.
